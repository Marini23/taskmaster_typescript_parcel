...
function renderArticles(): void {
  const articleContainer1 = document.querySelector(
    ".article-one"
  ) as HTMLElement;

  const articleContainer2 = document.querySelector(
    ".article-two"
  ) as HTMLHtmlElement;

  const articleContainer3 = document.querySelector(
    ".article-three"
  ) as HTMLHtmlElement;
