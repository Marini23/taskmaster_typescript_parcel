...
})({"cJVGY":[function(require,module,exports) {
...
var _logoTaskMaster1XJpg = require("../src/images/logo_TaskMaster_1x.jpg");
var _logoTaskMaster1XJpgDefault = parcelHelpers.interopDefault(_logoTaskMaster1XJpg);
var _logoTaskMaster2XJpg = require("../src/images/logo_TaskMaster_2x.jpg");
var _logoTaskMaster2XJpgDefault = parcelHelpers.interopDefault(_logoTaskMaster2XJpg);
var _symbolDefsSvg = require("../src/images/symbol-defs.svg");
...
const markup = `<nav class="navbar navbar-expand-xl">
        <div class="container-fluid">
          ...
          >
            <img
              srcset="${(0, _logoTaskMaster1XJpgDefault.default)} 1x, ${(0, _logoTaskMaster2XJpgDefault.default)} 2x"
              src="${(0, _logoTaskMaster1XJpgDefault.default)}"
              alt="logo"
              width="180"
              height="24"
      ...
      <div class="menu-list">
        <button type="button" class="btn-menu-close" aria-label="Close">
          <svg width="48" height="48" class="icon-close">
            <use href="${(0, _symbolDefsSvgDefault.default)}#icon-x"></use>
          </svg>
        </button>
        <ul class="list-items">
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    form.addEventListener("submit", (e)=>{
        ...
        if (titleTask.trim() === "" || categoryTask.trim() === "" || deadlineTask === "") (0, _notiflixNotifyAio.Notify).failure("Please fill in all required fields.", {
            ...
            if (descriptionTask.trim() !== "") newTask.description = descriptionTask;
            ...
            form.reset();
            closeModal();
            (0, _notiflixNotifyAio.Notify).success("Task added successfully!", {
                position: "center-center",
                timeout: 1000
            });
        }
...
},{"bootstrap/dist/css/bootstrap.min.css":"i5LP7","notiflix/build/notiflix-notify-aio":"eXQLZ","nanoid":"2ifus","../src/images/logo_TaskMaster_1x.jpg":"7pH9K","../src/images/logo_TaskMaster_2x.jpg":"hdNMk","../src/images/symbol-defs.svg":"3MF0u","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i5LP7":[function() {},{}],"2ifus":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./url-alphabet/index.js":false,"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7pH9K":[function(require,module,exports) {
module.exports = require("a36304b15d981c4").getBundleURL("fzQ5n") + "logo_TaskMaster_1x.741a4220.jpg" + "?" + Date.now();

},{"a36304b15d981c4":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"hdNMk":[function(require,module,exports) {
module.exports = require("23df1c4230edd81d").getBundleURL("fzQ5n") + "logo_TaskMaster_2x.9ad0eef4.jpg" + "?" + Date.now();

},{"23df1c4230edd81d":"lgJ39"}],"3MF0u":[function(require,module,exports) {
module.exports = require("acc0bd72c789a7f3").getBundleURL("fzQ5n") + "symbol-defs.a8b2e413.svg" + "?" + Date.now();

},{"acc0bd72c789a7f3":"lgJ39"}]},["cJVGY","96wtp"], "96wtp", "parcelRequire3bba")

//# sourceMappingURL=contacts.07b2d770.js.map
