...
function renderTasks(filteredTasks = tasksList) {
    const markupTasks = filteredTasks.map((task)=>{
      ...
      <use href="${0, _symbolDefsSvgDefault.default}#${task.isCompleted ? "icon-check2-circle" : "icon-circle"}" class="done-icon"></use>
    </svg>
            ...
            <div class="icons-container">
              <button type="button" class="icon-btn edit-btn">
                <svg width="30" height="30" class="svg-icon">
                  <use href="${0, _symbolDefsSvgDefault.default}#icon-pencil-fill"></use>
                </svg>
              </button>
              <button type="button" class="icon-btn delete-btn">
                <svg width="30" height="30" class="svg-icon">
                  <use href="${0, _symbolDefsSvgDefault.default}#icon-trash-fill"></use>
                </svg>
              </button>
            </div>
          </div>
...
function toggleTaskCompletion(taskId) {
    tasksList = tasksList.map((task)=>task.id === taskId ? {
            ...task,
...
tasks.addEventListener("click", (e)=>{
    ...
    if (target.closest(".delete-btn")) {
        ...
        if (taskId) {
            deleteTask(taskId);
            (0, _notiflixNotifyAio.Notify).info("Task deleted successfully!", {
    ...
    if (toggleCompleteElement) {
        ...
        if (taskId) {
            ...
            (0, _notiflixNotifyAio.Notify).success("Task completion status updated!", {
                position: "center-center",
                timeout: 1000
            });
        }
...
editForm.addEventListener("submit", (e)=>{
    ...
    if (editedTaskIndex !== -1) {
        ...
        localStorage.setItem(localStorageKey, JSON.stringify(tasksList));
        renderTasks();
        (0, _notiflixNotifyAio.Notify).success("Task updated successfully!", {
            position: "center-center",
            timeout: 1000
        });
        editModal.classList.add("hidden");
...
function applyFilters() {
    ...
    if (currentIsCompletedFilter === "active") filteredTasks = filteredTasks.filter((task)=>!task.isCompleted);
    else if (currentIsCompletedFilter === "completed") filteredTasks = filteredTasks.filter((task)=>task.isCompleted);
    // Apply category filter
    if (currentCategoryFilter !== "all") filteredTasks = filteredTasks.filter((task)=>task.category === currentCategoryFilter);
...
},{"bootstrap/dist/css/bootstrap.min.css":"i5LP7","notiflix/build/notiflix-notify-aio":"eXQLZ","../src/images/symbol-defs.svg":"8Af4Q","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i5LP7":[function() {},{}],"8Af4Q":[function(require,module,exports) {
module.exports = require("f762e286b277eadc").getBundleURL("7nNQX") + "symbol-defs.a8b2e413.svg" + "?" + Date.now();

},{"f762e286b277eadc":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}]},["5oX9A","ilMaF"], "ilMaF", "parcelRequire3bba")
