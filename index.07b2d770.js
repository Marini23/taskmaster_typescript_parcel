...
require("b40c5976cb0339ba");
const notiflix_notify_aio_1 = require("35a706d9a7e80b37");
const nanoid_1 = require("70b00c663757c9cd");
const logo_TaskMaster_1x_jpg_1 = __importDefault(require("aafe7ff49166e1da"));
const logo_TaskMaster_2x_jpg_1 = __importDefault(require("7000c031ecd3b3fb"));
const symbol_defs_svg_1 = __importDefault(require("6ddd55bc3bb043af"));
var Category;
(function(Category) {
    Category["Work"] = "work";
...
const markup = `<nav class="navbar navbar-expand-xl">
        <div class="container-fluid">
          ...
          >
            <img
              srcset="${logo_TaskMaster_1x_jpg_1.default} 1x, ${logo_TaskMaster_2x_jpg_1.default} 2x"
              src="${logo_TaskMaster_1x_jpg_1.default}"
              alt="logo"
              width="180"
              height="24"
      ...
      <div class="menu-list">
        <button type="button" class="btn-menu-close" aria-label="Close">
          <svg width="48" height="48" class="icon-close">
            <use href="${symbol_defs_svg_1.default}#icon-x"></use>
          </svg>
        </button>
        <ul class="list-items">
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    form.addEventListener("submit", (e)=>{
        ...
        if (titleTask.trim() === "" || categoryTask.trim() === "" || deadlineTask === "") notiflix_notify_aio_1.Notify.failure("Please fill in all required fields.", {
            ...
            form.reset();
            closeModal();
            notiflix_notify_aio_1.Notify.success("Task added successfully!", {
                position: "center-center",
                timeout: 1000
            });
        }
...
},{"b40c5976cb0339ba":"i5LP7","35a706d9a7e80b37":"eXQLZ","70b00c663757c9cd":"2ifus","aafe7ff49166e1da":"7pH9K","7000c031ecd3b3fb":"hdNMk","6ddd55bc3bb043af":"3MF0u"}],"i5LP7":[function() {},{}],"2ifus":[function(require,module,exports) {
...
},{}],"7pH9K":[function(require,module,exports) {
