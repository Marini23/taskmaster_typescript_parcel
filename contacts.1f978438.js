...
})({"aLsy6":[function(require,module,exports) {
...
btnLoadMore.forEach((button, index)=>{
    ...
    button.addEventListener("click", ()=>{
        ...
        const content = article === null || article === void 0 ? void 0 : article.querySelector(".article-load-more");
        if (content) {
            ...
            button.textContent = content.classList.contains("article-load-more-open") ? "Read Less..." : "Read More...";
        }
    });
});

},{"54b14e5512a0c40d":"i5LP7"}],"i5LP7":[function() {},{}]},["aLsy6","7elyk"], "7elyk", "parcelRequire3bba")

//# sourceMappingURL=contacts.1f978438.js.map
